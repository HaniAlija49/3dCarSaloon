...
const carsData = [
  ...
  { make: "Audi", model: "Q5", year: "2022", price: "35.000", glb: "audi.glb" },
  {
    make: "Volvo",
    model: "s60",
    year: "2017",
...
function init() {
  ...
  document
    ...
    .addEventListener("input", (event) => changeCarColor(event.target.value));
  document
    .getElementById("windowOpacitySlider")
